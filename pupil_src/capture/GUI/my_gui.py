...
class MyWindow():
    ...
    def startGui(self):
        ...
        global pictures
        global runWin
        self.pictureSource = "/home/horacekv/Pupil/pupil/pupil_src/capture/GUI/pics/"
        runWin = False
        pictures = []
        self.app = QtWidgets.QApplication(sys.argv)
    ...
    def runRun(self):
            if isCalibrated==True:
                ...
                if((row*column) == len(pictures)):
                    ...
                    run_ui = Ui_RunWindow()
                    run_ui.setupUi(RunWindow, row, column, pictures, self.pictureSource) ##rows, cols, field
    ...
    def runTileProcess(self,rows,cols):
        ...
        while runWin:#TODO get should close
            ...
            sleep(5)
            self.unhighlight(tile['x'], tile['y'])
            sleep(1)
